...
class ExecutionEngine:
    ...
    def route_order(
        self, symbol: str, quantity: float, side: str, price: float, adv: float = 1000000.0
    ) -> dict[str, Any]:
        """
        ...
        if self.simulation_mode:
            ...
            logger.info(
                f"SOR ROUTE: {side} {quantity} {symbol} at {executed_price:.2f} (Slippage: {slippage_pct * 10000:.2f} bps)"
            )
