...
async def get_watchlist(current_user: models.User = Depends(auth.get_current_active_user)):
    return current_user.watchlist


@router.post("/watchlist/{symbol}")
async def add_to_watchlist(
    symbol: str, current_user: models.User = Depends(auth.get_current_active_user)
):
    symbol = symbol.upper()
