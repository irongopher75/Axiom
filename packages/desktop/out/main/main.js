...
var require_remove = __commonJS({
  "node_modules/electron-updater/node_modules/fs-extra/lib/remove/index.js"(exports2, module2) {
    ...
    function remove(path3, callback) {
      if (fs2.rm) return fs2.rm(path3, { recursive: true, force: true }, callback);
      rimraf(path3, callback);
    }
    function removeSync(path3) {
      if (fs2.rmSync) return fs2.rmSync(path3, { recursive: true, force: true });
      rimraf.sync(path3);
    }
    module2.exports = {
      remove: u(remove),
...
`));
      ...
      static reconstructOriginalUrl(options) {
        ...
        return new url_1.URL(`${protocol}//${hostname}${port}${path3}`);
      }
...
var Platform = {
  ...
  getPythonPath() {
    ...
    if (import_node_fs.default.existsSync(venvPath)) {
      return venvPath;
    }
  ...
  getPythonLibPath() {
    ...
    const packagesDir = import_electron.app.isPackaged ? import_node_path.default.join(process.resourcesPath, "python-runtime", "packages") : paths.join(":");
...
async function createWindow() {
  ...
  if (import_electron3.app.isPackaged) {
    ...
    await mainWindow.loadFile(
      import_node_path2.default.join(__dirname, "../renderer/index.html")
    );
